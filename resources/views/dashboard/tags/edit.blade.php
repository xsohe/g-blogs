...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom mt-4">
    <div>
        <h1 class="h2 fw-normal mb-2">Edit a tag</h1>
    </div>
    <span class="fw-normal text-secondary mb-2"><a href="/dashboard/tags" class="text-decoration-none text-dark">My Tags</a> <i class="bi bi-arrow-right-short"></i> Edit</span>
</div>
<div class="container">
    <div class="row">
        <div class="col-lg-6">
