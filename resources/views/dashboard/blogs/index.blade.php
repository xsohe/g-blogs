...
<div class="container my-3">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom mt-4">
        <div>
            <h1 class="h2 fw-normal mb-2">My Blog</h1>
        </div>
        <span class="fw-normal text-secondary mb-2">My Blogs</span>
    </div>
    <div class="row">
        <div class="col-lg-8">
            @if (session('success'))
            ...
            @endif
            <div class="mb-3">
                <a href="/dashboard/blogs/create" class="btn btn-sm btn-cream">Create New Blog</a>
            </div>
            <div class="card">
                <div class="card-body">
                    <table class="table table-hover fs-6">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $blog->tag->name }}</td>
                                <td>
                                    <a href="/dashboard/blogs/{{ $blog->slug }}" class="badge text-dark">
                                        <span data-feather="eye" class="align-text-bottom"></span>
                                    </a>
                                    <a href="/dashboard/blogs/{{ $blog->slug }}/edit" class="badge text-dark">
                            ...
                            <tr>
                                <td colspan="4" class="text-center fs-5">
                                    <span class="text-center fs-6">No blogs found</span>
                                </td>
                            </tr>
                            @endif
                        </tbody>
